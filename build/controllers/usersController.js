      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return _User["default"].findByIdAndUpdate(_id, {
            ...
            "new": true
          } // mongoose update 이 후 문서를 반환하기 위한 옵션.
          );
        case 3:
          updatedUser = _context2.sent;
          req.session.user = updatedUser;
          return _context2.abrupt("return", res.render("/users/edit"));
        case 6:
        case "end":
...
var postJoin = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body2, name, username, email, password, password2, location, pageTitle, exists;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _req$body2 = req.body, name = _req$body2.name, username = _req$body2.username, email = _req$body2.email, password = _req$body2.password, password2 = _req$body2.password2, location = _req$body2.location;
          pageTitle = "Join";
